...
class EmailVerificationTest extends TestCase
{
    ...
    public function test_welcome_email_is_sent_once_email_is_verified(): void
    {
        $user = User::factory()->unverified()->create();
    ...
    /**
     * Re-visiting an already-used verification link must not re-send the
     * welcome email — VerifyEmailController only dispatches Verified on the
     * transition from unverified to verified.
     */
    public function test_revisiting_verification_link_does_not_resend_welcome_email(): void
    {
