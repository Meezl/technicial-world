...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        $middleware->web(append: [
            ...
            // Accounts still on a mailed password go no further than the
            // set-password screen. Appended after Inertia so the redirect it
            // issues is one Inertia understands.
        ...
        $middleware->alias([
            ...
            // Property Management & Corporate module. Off by default; see
            // config/corporate.php.
            'corporate' => \App\Http\Middleware\EnsureCorporateModuleEnabled::class,
        ]);
